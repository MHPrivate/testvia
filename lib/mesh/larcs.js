...
module.exports = extend(exports, {
    handlers: { // _this_ is the larc socket for each handler
        ...
        heartbeat: function onHeartbeat() { // conditionally share our updated authority SSL certificate
            debug.enabled && debug('onHeartbeat:', this.locals.access.name, this.locals.access.dialPrefix);
            process.emit('larcPresent', this.locals.ipv4 || this.locals.ipv6);
        ...
        cdr: function onCdr(cdr, cb) {
            ...
            chain(function cleanup(err) {
                if (typeof cb === 'function')
                    err ? cb(err.sqlMessage || err.message) : cb.apply(null, arguments);
