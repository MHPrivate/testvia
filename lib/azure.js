...
process.running.wait.push(process.running.then(function azureStartup() {
    var context = context = Object.defineProperty({} , 'axios', { writable: true, enumerable: false, configurable: true });
...
function onRoutingLookup(session, cb) {
    var cli,
        context = Object.defineProperty(session.context, 'axios', { writable: true, enumerable: false, configurable: true }),
        devicenumber,
...
function onBsiaSpawnCalls(catalogue, communicator, cb) {
    var cli,
        context = context = Object.defineProperty(communicator.session.context, 'axios', { writable: true, enumerable: false, configurable: true }),
        devicenumber,
...
function onWriteCallData(session, cb) {
    var cli,
        context = context = Object.defineProperty(session.context, 'axios', { writable: true, enumerable: false, configurable: true }),
        diagnostics,
        now = new Date,
        payload = session.payload;
