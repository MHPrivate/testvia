...
Object.assign(Establish, { // class setup
    ...
    enter: function () {
        ...
        debug(this.communicator.session.sid, 'Establish.enter:', 'spandsp_start_tone_detect');
    ...
    leave: function () {
        ...
        chain(function cleanup(err) {
            ...
            if (sm.communicator.stmf) // retain spandsp-tone-detection if we have established using STMF
                return this();
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            var n = sm.communicator.session.context.tt92Stmf ? 0 : 1;
