...
function Establish(communicator) {
    ...
    Establish.super_.call(this, Establish, { // instance setup
        ...
        utcs: [],                   // array of reportable timestamps
...
Object.assign(Establish, { // class setup
    ...
    leave: function () {
        ...
        debug.enabled && debug(this.communicator.session.sid, 'Establish.leave:', JSON.stringify({ firstMs: this.utcs[1] - this.utcs[0] }));
    ...
    action: function () {
        ...
        this.utcs.length || this.utcs.push(Date.now());
