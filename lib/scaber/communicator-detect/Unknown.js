...
module.exports = new (function Unknown() {
    Object.assign(this, {
...
Object.assign(Establish, { // class setup
    enter: function () {
        ...
        if ('unknown' in this.communicator.session.context === false)
            return this.timeout = worker.resetTimeout(this.timeout, this.enter.bind(this, null, 'refused'), 0);

        return this.timeout = worker.resetTimeout(this.timeout, this.signal.bind(this, 'action'), 0);
    },
