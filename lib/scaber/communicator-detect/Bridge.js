...
Object.assign(Establish, { // class setup
    enter: function () {
        ...
        this.timeout = worker.resetTimeout(this.timeout, this.signal.bind(this, 'conclude'), 0);
    },
    ...
    conclude: function (bridge) {
        ...
        debug.enabled && debug(this.communicator.session.sid, 'Establish.conclude:', JSON.stringify({ concludeMs: Date.now() - this.communicator.answered, conclusion: conclusion }));
