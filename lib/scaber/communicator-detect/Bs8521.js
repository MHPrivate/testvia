...
Object.assign(Establish, { // class setup
    ...
    timeout: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.communicator.session.sid, this.timeout, this.enter.bind(this, null), Establish.ackMs);
...
Object.assign(Speech, { // class setup
    ...
    action: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.communicator.session.sid, this.timeout, this.signal.bind(this, 'action'), Speech.silenceMs);
        var sm = this;
        chain(function (err) {
...
Object.assign(Null, { // class setup
    ...
    action: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.communicator.session.sid, this.timeout, this.enter.bind(this, null), Null.silenceMs);
        var sm = this;
        chain(function cleanup(err) {
