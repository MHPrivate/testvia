...
Object.assign(Establish, { // class setup
    ...
    timeout: function () {
        ...
        var parsed = {}, match;
        Establish.A26H.lastIndex = this.lastIndex;
        while (match = Establish.A26H.exec('#' + this.data)) { // untill verified, for-each matching segment
        ...
        if (this.communicator.session.context.bs8521Any) // redirect dial-string for any TTNew Communicator
...
Object.assign(Null, {
    ...
    leave: function () {
        ...
        this.timeout = worker.resetTimeout(this.timeout);
        this.communicator.signal('phase', 'null');
    },
    action: function () {
