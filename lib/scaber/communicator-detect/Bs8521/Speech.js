...
require('util').inherits(module.exports = exports = Speech, require('../../../state-machine'));
...
Object.assign(exports, { // class setup
    ...
    enter: function () {
        debug(this.communicator.session.sid, 'enter:', exports.actionMs);
    ...
    action: function () {
        ...
        chain(function (err) {
            ...
            debug(sm.communicator.session.sid, 'action.2:', 'send_dtmf', sm.tones);
