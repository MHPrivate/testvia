...
module.exports = exports = new (function TtNew() {
    Object.assign(this, {
...
Object.assign(Establish, { // class setup
    ...
    leave: function (conclusion) {
        ...
        chain(function cleanup(err) {
            ...
            debug(sm.communicator.session.sid, 'Establish.leave.1:', 'block_dtmf');
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            debug(sm.communicator.session.sid, 'Establish.action:', 'send_dtmf', 'ENQ', Establish.enqTones, new Date);
    ...
    timeout: function () {
        ...
        chain(function cleanup(err) {
            ...
            debug(sm.communicator.session.sid, 'Establish.timeout:', 'send_dtmf', 'ACK', Establish.ackTones, new Date);
