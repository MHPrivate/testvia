...
Object.assign(Establish, {
    ...
    sendData: function () {
        ...
        this.sent = true;
        worker.legDtmf(this.consumer, this.dataDtmf, undefined); // send only
...
Object.assign(Commands, { // class setup
    ...
    '/A0(\\d{4})#$': function (match) { // unit select
        ...
        worker.legDtmf(this.consumer, ackSelect, undefined); // send only
    ...
    '/A1(\\d{4})#$': function (match) { // catalogue
        ...
        worker.legDtmf(this.consumer, ackNext, undefined); // send only
    ...
    '/A2(\\d{2})(\\d{2})#$': function (match) { // equipment control (testing: [2]21234#)
        ...
        worker.legDtmf(this.consumer, ackCtrl, undefined); // send only
    ...
    '/A3(\\d)#$': function (match) { // speech-control  (testing: [2]3n#)
        ...
        worker.legDtmf(this.consumer, Commands.ackDtmf, undefined); // send only
    ...
    '/A4(\\d{2})(\\d{3})(\\d{20})#$': function (match) { // parameter-define  (testing: [2]41234501234568901234567890#)
        ...
        worker.legDtmf(this.consumer, ackParm, undefined); // send only
    ...
    '/AC(\\d{4})#$': function (match) { // programming-mode (testing: [28]1234#)
        ...
        worker.legDtmf(this.consumer, Commands.ackProg, undefined); // send only
    ...
    '/B$': function (match) { // acknowledge (testing: [5]#)
        ...
        worker.legDtmf(this.consumer, Commands.ackNext, undefined); // send only
    ...
    '/a9$': function (match) { // quick-clear (testing: [*]9)
        ...
        worker.legDtmf(this.consumer, ackClear, undefined); // send only
