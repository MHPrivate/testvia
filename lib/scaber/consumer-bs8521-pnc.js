...
Object.assign(Establish, {
    ...
    enter: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.session.sid, this.timeout, this.signal.bind(this, 'sendGuard'), Establish.initialMs);
        return this;
    },
    leave: function () {
        if (this.leaving++) // already leaving - prevent recursion
    ...
    sendGuard: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.session.sid, this.timeout, this.signal.bind(this, 'sendGuard'), Establish.guardMs || 2000);
    ...
    sendData: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.session.sid, this.timeout, this.signal.bind(this, 'sendData'), Establish.dataMs || 5180);
        this.sent = true;
...
Object.assign(Commands, { // class setup
    ...
    enter: function (cb) {
        ...
        this.timeout = worker.resetTimeout.call(this.session.sid, this.timeout, this.enter.bind(this, null), ConsumerBs8521Pnc.nullMs || 130000);
        return this;
    },
    leave: function () {
        if (this.leaving++) // already leaving - prevent recursion
    ...
    '/a9$': function (match) { // clear (testing: [*]9)
        ...
        //this.success = true;
        //this.timeout = worker.resetTimeout.call(this.session.sid, this.timeout, this.enter.bind(this, null), ConsumerBs8521Pnc.closeMs);
    },
