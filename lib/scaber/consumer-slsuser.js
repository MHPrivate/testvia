...
Object.assign(ConsumerSlsUser, { // _this_ of all methods is the StateMachine instance
    ...
    atmCommandControlRelease1: function () {
        debug(this.session.sid, 'atmCommandControlRelease1:', ConsumerSlsUser.doorRelease, new Date);
        worker.legDtmf(this, ConsumerSlsUser.doorRelease, undefined, 'rel'); // send only
    },
    atmCommandControlRelease2: function () {
        debug(this.session.sid, 'atmCommandControlRelease2:', ConsumerSlsUser.doorRelease, new Date);
        worker.legDtmf(this, ConsumerSlsUser.doorRelease, undefined, 'rel'); // send only
    },
    atmCommandControlReleaseKeysafe: function () {
        debug(this.session.sid, 'atmCommandControlReleaseKeysafe:', ConsumerSlsUser.doorRelease, new Date);
        worker.legDtmf(this, ConsumerSlsUser.doorRelease, undefined, 'rel'); // send only
    },
    atmCommandControlReleaseAll: function () {
        debug(this.session.sid, 'atmCommandControlReleaseAll:', ConsumerSlsUser.doorRelease, new Date);
        worker.legDtmf(this, ConsumerSlsUser.doorRelease, undefined, 'rel'); // send only
    },
