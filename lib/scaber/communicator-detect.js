...
Object.assign(CommunicatorDetect, { // _this_ of all methods is the StateMachine instance
    ...
    close: function onCommunicatorClose() { // from clear/cleared/catalogued
        ...
        else if (this.protocols[0].Close)
            this.signal('substate', this.protocols[0].Close, 'closed', undefined); // abandon substate processing
        else
            this.signal('release');
        return this;
    },
    ...
    keepalive: function onCommunicatorDetectKeepalive() { // setup OR reset keepalive interval - from establish
    ...
    catalogued: function onCommunicatorDetectCatalogued(data) { // from cleared/established
    ...
    selected: function onCommunicatorDetectSelected(data) { // from established/catalogued
