...
function legDtmf(leg, dtmf, lock, diagnostic, cb) {
    ...
    dtmf && leg.session.signal('diagnostic', diagnostic);
    debug(leg.session.sid, 'legDtmf:', JSON.stringify({ dtmf: dtmf, passDtmf: leg.session.context.passDtmf || false }), new Date);
