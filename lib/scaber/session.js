...
var sessionState = { // _this_ of all methods is the StateMachine instance
    ...
    offerOutcome: function onSessionOfferOutcome(accepted) { // Boolean
        ...
        var alegHeaders = (this.locals.alegEvt || { headers: {} }).headers;
        if (alegHeaders['Caller-Destination-Number'] === 'nowip') // have a nowip call-leg
            this.locals.communicator = new main.modules.CommunicatorNowip(this);
        else if (alegHeaders['Caller-Destination-Number'] === 'scaip') // have a scaip call-leg
            this.locals.communicator = new main.modules.CommunicatorScaip(this);
        else // no call-leg - expecting JSON from websvc
            this.locals.communicator = new main.modules.Communicator(this); // default Communicator replaces itself when JSON received
    },
    ...
    consume: function onSessionConsume() {
        ...
        consumers.length || consumers.push(new main.modules.ConsumerNowipVolt(
            this,
            '01472278521@volt-acton.appello.care:5066,01472278521@volt-slough.appello.care:5066'
            //'user/martin'
        ));
        while (true) {
