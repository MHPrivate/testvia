        ...
        switch (type) {
            ...
            case 'control': // ('control', match, control) - control is a string
                switch (arguments[2]) {
                    ...
                    case 'releaseKeysafe':
                    case 'releaseAll':
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '9@200', this.uuid, null, ()=>ok());
                    case 'undefined':
                    case 'relay1On':
                    case 'relay1Off':
                    case 'relay2On':
            ...
            case 'quick': // ('quick', match, quick) - quick is a string
                switch (arguments[2]) {
                    case 'speak': // ack: B
                        ...
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '8@200', this.uuid, null, ()=>ok());
                        break;
                    case 'listen': // ack: B
                        this.speech = undefined;
                        this.direction = 'listen';
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '7@200', this.uuid, null, ()=>ok());
                        break;
                    case 'clear': // status: A000000#
                        break;
                    case 'close': // ack: B
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '0@200', this.uuid, false, ()=>ok());
                        break;
                    case 'null': // ack: B ????
                        var dtmf = { duplex: '4@200', listen: '7@200', speak: '8@200' }[this.speech || this.direction];
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), dtmf || '4@200', this.uuid, null, ()=>ok());
                        break;
                }
                break;
            ...
            case 'speech': // ('speech', match, speech) - speech is a string
                switch (arguments[2]) {
                    ...
                    case 'volume3': // ack: B
                        break;
                    case 'volumeUp': // ack: B
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '3@200', this.uuid, null, ()=>ok());
                        break;
                    case 'volumeDn': // ack: B
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '1@200', this.uuid, null, ()=>ok());
                        break;
                    case 'speaker1': // ack: B
                        break;
                    case 'speaker2': // ack: B
                    ...
                    case 'duplex': // ack: B
                        ...
                        return esl.sendDtmf.call(debug.bind(null, this.session.sid, arguments[2]), '4@200', this.uuid, null, ()=>ok());
                        break;
                    case 'simplex': // ack: B
                        this.speech = undefined;
                        this.direction = 'listen';
