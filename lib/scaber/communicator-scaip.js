...
module.exports = exports = Object.assign(CommunicatorScaip, {
...
Object.assign(CommunicatorScaip, {// _this_ of all methods is the StateMachine instance
    ...
    answer: function onCommunicatorScaipAnswer() { // request to answer a-leg if not already answered
        ...
        this.keepalive = worker.resetInterval.call(this.session.sid, this.keepalive, this.signal.bind(this, 'send', 'speechDuplex'), 60000);
        return this;
    },
    ...
    MESSAGE: function onCommunicatorScaipMessage(evt, first) {
        ...
        mrq.crd.forEach(function (crd, idx, arr) {
            (crd = crd.match(reCrd)) && (this[crd[1]] = crd[0]); // e.g. { 'gsm:': 'gsm:+447802827727', 'sip:': 'sip:12345@a.b.c.d' }
        }, crds = {});
        switch (mrq.mty[0]) {
