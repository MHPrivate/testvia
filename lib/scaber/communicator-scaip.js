...
var communicatorState = {// _this_ of all methods is the StateMachine instance
    ...
    MESSAGE: function onCommunicatorScaipMessage(evt, first) {
        ...
        var stc = +mrq.stc[0], crds; // no-voice: gsm: sip: sip-pp:
