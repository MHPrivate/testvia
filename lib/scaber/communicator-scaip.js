...
Object.assign(exports, {// _this_ of all methods is the StateMachine instance
    ...
    MESSAGE: function onCommunicatorScaipMessage(evt, first) {
        ...
        if (+mrq.mreq[0] !== 4 && (this.callerId = crds['sip:'])) {
            ...
            chain(function cleanup(err) {
            ...
            }, function (tnu) { // 'gsm:+e164' //Object tnu.tag 'gsm:+e164' tnu.cli is expected inbound cli or doesn't exist (training scenario)
                ...
                sm.tnu.splice(0, main.hack.multiTnu ? 0 : sm.tnu.length, tnu.tag); // multiple OR single <tnu> nodes (multiple not currently supported by Essence & Neat)
