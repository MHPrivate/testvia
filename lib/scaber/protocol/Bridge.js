...
Object.assign(Establish, { // class setup
    ...
    leave: function (conclusion) {
        ...
        debug.enabled && debug(this.leg.session.sid, 'Establish.leave:', UTIL.stringify({ conclusion: conclusion }));
    ...
    conclude: function (bridge) {
        ...
        debug.enabled && debug(this.leg.session.sid, 'Establish.conclude:', UTIL.stringify({ conclusion: conclusion }), new Date);
