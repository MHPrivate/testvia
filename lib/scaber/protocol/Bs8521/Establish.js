...
Object.assign(exports, { // class setup
    ...
    timeout: function () {
        ...
        if (bs8521.grouped && 'bs8521Grp' in this.communicator.session.context) // redirect dial-string for any BS8521 Grouped Communicator
        ...
        Object.assign(this.communicator, { grouped: bs8521.grouped ? { unit: bs8521.unit } : undefined, hvs: bs8521.$.speech === 1 });
