...
Object.assign(exports, { // class setup
    ...
    action: function () {
        ...
        debug(this.leg.session.sid, 'action:', 'send_dtmf', 'ENQ', exports.enqTones, exports.enqMs + 'ms', new Date);
        worker.legDtmf(this.leg, exports.enqTones, undefined); // send only
        //esl.executeAsyncX('send_dtmf', [exports.enqTones], this.leg.uuid);
    },
    ...
    timeout: function () {
        ...
        this.timeout = worker.resetTimeout.call(this.leg.session.sid, this.timeout, this.enter.bind(this, null), exports.ackMs);
        debug(this.leg.session.sid, 'timeout:', 'send_dtmf', 'ACK', exports.ackTones, exports.ackMs + 'ms', new Date);
        worker.legDtmf(this.leg, exports.ackTones, undefined); // send only
        //esl.executeAsyncX('send_dtmf', [exports.ackTones], this.leg.uuid);
    },
});
