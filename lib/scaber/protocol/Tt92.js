...
module.exports = exports = new (function Tt92() {
    Object.assign(this, {
        ...
        listenStmf: '%(75,5,941);%(75,5,1209);'.repeat(3), // stmf also used for keepalive
        parse: parse,                               // validating parser function for TT92 data
        speakDtmf: 'c@500',                         // dtmf also used for keepalive
        speakStmf: '%(75,5,852);%(75,5,1633);'.repeat(3), // stmf also used for keepalive
        tonesCmd: ['send_dtmf', 'gentones'],        // signalling command to use, indexed on leg.stmf
        ...
        arcDtmf: { // permitted agent tone generation [dtmf, stmf]
            '1': ['1@400', '%(75,5,697);%(75,5,1209);'],
            '2': ['2@400', '%(75,5,697);%(75,5,1336);'],
            '3': ['3@400', '%(75,5,697);%(75,5,1477);'],
            'A': [null, null], // ['A@400', '%(75,5,697);%(75,5,1633);'],
            '4': ['4@400', '%(75,5,770);%(75,5,1209);'],
            '5': ['5@400', '%(75,5,770);%(75,5,1336);'],
            '6': ['6@400', '%(75,5,770);%(75,5,1477);'],
            'B': [null, null], // ['B@400', '%(75,5,770);%(75,5,1633);'],
            '7': ['7@400', '%(75,5,852);%(75,5,1209);'],
            '8': ['8@400', '%(75,5,852);%(75,5,1336);'],
            '9': ['9@400', '%(75,5,852);%(75,5,1477);'],
            'C': [null, null], // ['C@400', '%(75,5,852);%(75,5,1633);'],
            '*': [null, null], // ['*@400', '%(75,5,941);%(75,5,1209);'],
            '0': [null, null], // ['0@400', '%(75,5,941);%(75,5,1336);'],
            '#': [null, null], // ['#@400', '%(75,5,941);%(75,5,1477);'],
            'D': [null, null], // ['D@400', '%(75,5,941);%(75,5,1633);'],
        },
    });
})();
    ...
    switch (type) {
        ...
        case 'control': // ('control', match, control) - control is a string
            switch (arg2) {
                ...
                case 'resume':
                    break;
                case 'exit':
                    match.send = '*c@500+wd*@80'; // listen/speak wait prog-done
        ...
        case 'program': // ('program', match, pin) - ignores ACK - pin is numeric
            if (!this.grouped) { // dispersed only
                match.send = 'c*wc*@500+wc@80'; // speak/listen wait speak/listen wait speak
                Substate = match.send ? exports.Generic : undefined;
            }
            break;
            ...
            switch (arg2) {
                case 'speak': // ack: B
                    ...
                    if (!this.grouped || this.speech === 'simplex') {
                        match.send = this.stmf ? exports.speakStmf : exports.speakDtmf;
                        Substate = exports.Generic;
                ...
                case 'listen': // ack: B
                    if (this.speech === 'legacy')
                        this.speech = 'simplex';
                    if (!this.grouped || this.speech === 'simplex') {
                        match.send = this.stmf ? exports.listenStmf : exports.listenDtmf;
                        Substate = exports.Generic;
                ...
                case 'null': // ack: B ????
                    if (this.stmf)
                        match.send = (this.direction === 'speak') ? exports.speakStmf : exports.listenStmf;
                    else
            ...
            switch (arg2) {
                ...
                case 'simplex': // ack: B
                    if (!this.grouped) { // always deliver to dispersed Legs
                        ...
                        match.send = this.stmf ? exports.speakStmf : exports.speakDtmf; // just speak, listen is explicitly sent by carenet
                        Substate = exports.Generic;
                        this.direction = 'speak';
                    }
                    this.speech = 'simplex';
        ...
        case 'dtmf':
            match.send = !this.session.context.passDtmf && exports.arcDtmf[arg2] && exports.arcDtmf[arg2][+this.stmf];
