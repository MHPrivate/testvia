...
Object.assign(exports, { // class setup
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            debug(sm.leg.session.sid, 'action.2:', module.parent.exports.tonesCmd[n], selectTones[n], ms + 'ms', new Date);
            if (n) {
                sm.leg.session.signal('diagnostic', 'sel');
                esl.executeAsyncX(module.parent.exports.tonesCmd[n], selectTones[n], sm.leg.uuid, this);
            } else {
                worker.legDtmf(sm.leg, selectTones[n], null, 'sel', this); // allow+send+block
            }
    ...
    timeout: function () {
        ...
        if (this.parsed = module.parent.exports.parse(this.data, module.parent.exports.parse.alarm8)) // alarm-digits
            ...
            this.enter(null);
        debug(this.leg.session.sid, 'timeout:', this.data, this.parsed ? 'parsed' : 'invalid', this.leg.grouped && JSON.stringify(this.leg.grouped.alarms), new Date);
