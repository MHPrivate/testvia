...
Object.assign(Stabilise, { // class setup
    ...
    ackDtmf: 'b0@80',               // DTMF to acknowledge DataMessage
    dumpMs: 10000,                  // silence delay to forced hangup
    enqDtmf: '0#@80',               // DTMF to provoke the DataMessage
    ...
    actionEnq: function () {
        ...
        worker.legDtmf(this.leg, Stabilise.enqDtmf, undefined, 'en9'); // send only
    },
    actionAck: function () {
