...
Object.assign(Stabilise, { // class setup
    ...
    ackTones: 'b0@80',              // DTMF to acknowledge DataMessage
    dumpMs: 10000,                  // silence delay to forced hangup
    enqTones: '0#@80',              // DTMF to provoke the DataMessage
    ...
    actionEnq: function () {
        ...
        worker.legDtmf(this.leg, Stabilise.enqTones, undefined, 'en9'); // send only
    },
    actionAck: function () {
