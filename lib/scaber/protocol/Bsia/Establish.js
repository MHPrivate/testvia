...
Object.assign(exports, { // class setup
    ...
    DTMF: function (evt) {
        ...
        debug(this.leg.session.sid, 'DTMF:', evt.headers['DTMF-Digit'] + '@' + durationMs, JSON.stringify(this.data), timeoutMs + 'ms', new Date);
        return this;
    },
    timeout: function () {
        debug(this.leg.session.sid, 'timeout:', JSON.stringify(this.data));
        if (this.data[0]) // received DTMF - so note the protocol for CDR generation
