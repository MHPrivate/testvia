...
Object.assign(exports, { // class setup
    ...
    ackTones: 'v=-0;%(750,0,1400);',            // tones to ACK device data
    enqMs: 1299,        // repeat ENQ delay
    enqTones: '%(100,100,1400);%(100,1,2300);', // tones to ENQ device data
    ...
    action: function () {
        ...
        var ms = worker.legDtmf(this.leg, exports.enqTones, undefined, 'enD') + exports.enqMs; // send only TGML
        debug(this.leg.session.sid, 'action:', 'HS', exports.enqTones, ms + 'ms', new Date);
        this.timeout = worker.resetTimeout.call(this.leg.session.sid, this.timeout, this.signal.bind(this, 'action'), ms); // usually 1500ms
    },
    ...
    timeout: function () {
        ...
        worker.legDtmf(this.leg, exports.ackTones, undefined, 'ack'); // send only TGML
        debug(this.leg.session.sid, 'timeout:', 'ACK', exports.ackTones, new Date);
    },
});
