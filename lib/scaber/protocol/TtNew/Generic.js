...
Object.assign(exports, { // class setup
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            debug(sm.leg.session.sid, 'action.2:', 'send_dtmf', sm.args[1].send, dtmfMs + 'ms', new Date);
    ...
    DTMF: function (evt) {
        ...
        if (this.args[1].regex) // only update timeout if we're waiting for a response
            this.timeout = worker.resetTimeout.call(this.leg.session.sid, this.timeout, this.signal.bind(this, 'timeout'), exports.idleMs);
        return this;
    },
    timeout: function () {
