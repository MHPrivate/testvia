...
Object.assign(exports, { // class setup
    ...
    leave: function (abort) {
        ...
        debug.enabled && debug(this.communicator.session.sid, 'leave:', JSON.stringify({ selected: this.communicator.selected }));
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            sm.timeout = worker.resetTimeout.call(sm.communicator.session.sid, sm.timeout, sm.enter.bind(sm, null), exports.alarmMs);
