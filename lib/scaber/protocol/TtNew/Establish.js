...
Object.assign(exports, { // class setup
    ...
    enqDtmf: 'db@80',       // DTMF to provoke the DataMessage
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            var ms = worker.legDtmf(sm.leg, exports.enqDtmf, undefined, 'enN', this) + exports.enqMs; // send only
            debug(sm.leg.session.sid, 'action.1:', 'ENQ', exports.enqDtmf, ms + 'ms', new Date);
    ...
    timeout: function () {
        ...
        debug.enabled && debug(this.leg.session.sid, 'timeout:', UTIL.stringify(tt));
        if (!(tt || {}).verified)
        ...
        var ackMs = exports.ackMs + esl.dtmfMs(exports.ackDtmf);
        var sm = this;
        chain(function cleanup(err) {
            ...
            debug(sm.leg.session.sid, 'timeout.1:', 'ACK', exports.ackDtmf, ackMs + 'ms', new Date);
            ackMs += Date.now();
