...
Object.assign(exports, { // class setup
    ...
    leave: function (abort) {
        ...
        debug.enabled && debug(this.leg.session.sid, new Date, 'leave:', UTIL.stringify({ selected: this.leg.selected, speech: this.leg.speech || 'duplex', fetched: fetched, parsed: this.parsed, payload: payload }));
    ...
    action: function () {
        ...
        chain(function cleanup(err) {
            ...
            worker.legDtmf(sm.leg, selectTones, null, 'sel', this); // allow+send+block
    ...
    timeout: function () {
        ...
        if (this.parsed = module.parent.exports.parse(this.data, module.parent.exports.parse.alarm8)) // alarm-digits
            ...
            this.enter(null);
        debug.enabled && debug(this.leg.session.sid, new Date, 'timeout:', this.data, this.parsed ? 'parsed' : 'invalid', this.leg.grouped && UTIL.stringify(this.leg.grouped.alarms));
