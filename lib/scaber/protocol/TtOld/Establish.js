...
Object.assign(exports, { // class setup
    ...
    action: function () {
        ...
        var enqMs = esl.tgmlMs(exports.enqTones) + exports.enqMs; // usually 2000ms + 7000ms
        ...
        chain(function cleanup(err) {
            ...
            debug(sm.leg.session.sid, new Date, 'action.3:', 'gentones', 'ENQ', exports.enqTones, enqMs + 'ms');
            sm.leg.session.signal('diagnostic', 'enO');
    ...
    timeout: function () {
        ...
        debug(this.leg.session.sid, new Date, 'timeout.1:', 'gentones', 'ACK', exports.ackTones, ackMs + 'ms');
