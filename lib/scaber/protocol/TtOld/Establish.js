...
Object.assign(exports, { // class setup
    ...
    DETECTED_TONE: function (evt) {
        ...
        debug(this.leg.session.sid, new Date, 'TONE:', evt.headers['Detected-Tone'], JSON.stringify(this.data), exports.silenceMs);
        return this;
    },
    timeout: function () {
        ...
        if (/^\d{4,5}$/.test(this.data[0]) === false || this.data[0] !== this.data[1]) {
            debug.enabled && debug(this.leg.session.sid, new Date, 'timeout:', JSON.stringify({ data: this.data }));
        ...
        debug.enabled && debug(this.leg.session.sid, new Date, 'timeout:', JSON.stringify({ data: this.data, tt: tt }));
