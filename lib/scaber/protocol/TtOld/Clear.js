...
Object.assign(exports, { // class setup
    ...
    clearTones: '*@500+0@1000', // digit-string to clear a grouped device
    ...
    leave: function (abort) {
        ...
        debug.enabled && debug(this.leg.session.sid, new Date, 'leave:', JSON.stringify({ selected: this.leg.selected }));
    ...
    action: function () {
        ...
        //
        //}, function (evt) {
            debug(sm.leg.session.sid, new Date, 'action.2:', 'send_dtmf', exports.clearTones, esl.dtmfMs(exports.clearTones) + 'ms');
            worker.legDtmf(sm.leg, exports.clearTones, null, this); // allow+send+block
            //esl.executeAsyncX('send_dtmf', [exports.clearTones], sm.leg.uuid, this);
        //
        //}, function () {
