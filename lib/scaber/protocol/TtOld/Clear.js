...
Object.assign(exports, { // class setup
    clearDtmf: '*@500+0@1000', // digit-string to clear a grouped device
    clearMs: 2000,          // 1st alarm-digits timeout
    ...
    leave: function (abort) {
        ...
        debug.enabled && debug(this.leg.session.sid, new Date, 'leave:', UTIL.stringify({ selected: this.leg.selected }));
    ...
    action: function () {
        ...
        var ms = worker.legDtmf(this.leg, exports.clearDtmf, null, 'clr') + exports.clearMs; // allow+send+block
        debug(this.leg.session.sid, 'action:', exports.clearDtmf, ms + 'ms', new Date);
