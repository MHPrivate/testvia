...
Object.assign(Stabilise, { // class setup
    ...
    actionEnq: function () {
        ...
        worker.legDtmf(this.leg, Stabilise.enqTones, undefined, 'enO'); // send only
    },
    actionAck: function () {
        ...
        worker.legDtmf(this.leg, Stabilise.ackTones, undefined, 'ack'); // send only
    },
    actionFdc: function () {
        if (!this.tt.hvs)
        ...
        worker.legDtmf(this.leg, Stabilise.fdcTones, undefined, 'fdc'); // send only
