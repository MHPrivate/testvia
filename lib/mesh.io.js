...
function Mesh(srv, opts) { // NOT a Constructor
    ...
    Object.defineProperty(self, 'mesh', {
        ...
        value: Object.create({}, {
            ...
            close: { enumerable: false, value: self.close },    // prepare to intercept sio:close
            listen: { enumerable: false, value: self.listen },  // prepare to intercept sio:listen
    ...
    self.close = close;             // intercept sio:close
    self.emit2peers = emit2peers;   // extra method
    self.getPeers = getPeers;       // extra method
    self.listen = listen;           // intercept sio:listen
