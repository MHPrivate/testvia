...
module.exports= extend(exports, {
    ...
    http: null,
    reqs: extend([], { limit: 50 }),
});

app.set('views', __dirname + '/../fsxml');
...
app.use(function (err, req, res, next) {
    ...
    if (err.status !== 404) {
        ...
        (exports.errs.unshift(err) > exports.errs.limit) && exports.errs.limit && (exports.errs.length = exports.errs.limit);
        err.req = req;
    }
...
process.once('running', function () {
    ...
    exports.http = http.createServer(app).listen(8020, function () {
